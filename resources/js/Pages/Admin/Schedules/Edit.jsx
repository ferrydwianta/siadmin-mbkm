...
export default function Edit(props) {
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        selected_registrations: props.selected_registrations ?? [],
    ...
    const onHandleReset = () => {
        reset();
        multiSelectRef.current?.setValue(props.selected_registrations ?? []);
    };
                        ...
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
                            ...
                            <div className="col-span-full">
                                ...
                                <MultiSelect
                                    ...
                                    defaultValue={props.selected_registrations}
