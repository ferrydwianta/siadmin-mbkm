...
import { IconArrowsDownUp, IconPencil, IconPlus, IconRefresh, IconSpeakerphone, IconTrash } from '@tabler/icons-react';
import { useState } from 'react';

export default function Index(props) {
    const { data: announcements, meta, links } = props.announcements;
                ...
                <CardContent className="p-0 [&-td]:whitespace-nowrap [&-td]:px-6 [&-th]:px-6">
                    {announcements.length == 0 ? (
                        <EmptyState
                            ...
                            subTitle="Mulailah dengan menambahkan pengumuman baru!"
                        />
                    ) : (
                            ...
                            <TableBody>
                                {announcements.map((announcement, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>{formatDateIndo(announcement.created_at)}</TableCell>
                                        <TableCell>
