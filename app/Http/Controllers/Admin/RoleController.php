...
class RoleController extends Controller
{
    public function index(): Response
    {
        ...
        return inertia('Admin/Roles/Index', [
            'page_settings' => [
                'title' => 'Peran',
                'subtitle' => 'Menampilkan data roles yang tersedia pada sistem.'
            ],
    ...
    public function create(): Response
    {
        return inertia('Admin/Roles/Create', [
            'page_settings' => [
                'title' => 'Tambah peran',
                'subtitle' => 'Buat peran baru. Klik simpan setelah selesai!',
                'method' => 'POST',
    ...
    public function edit(Role $role): Response
    {
        return inertia('Admin/Roles/Edit', [
            'page_settings' => [
                'title' => 'Edit peran',
                'subtitle' => 'Edit peran. Klik simpan setelah selesai!',
                'method' => 'PUT',
